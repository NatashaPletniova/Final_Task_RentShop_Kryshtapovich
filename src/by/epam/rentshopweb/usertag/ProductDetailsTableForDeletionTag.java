...
public class ProductDetailsTableForDeletionTag extends TagSupport {
	...
	public int doStartTag() throws JspTagException {
		...
		try {
			...
			for(int i=0; i<size; i++) {
				...
				pageContext.getOut().write("</td>");
				pageContext.getOut().write("<form action='Controller' method='post' name='delete-product-item'>");
				pageContext.getOut().write("<input type='hidden' name='command' value='delete-product-item' />");
				pageContext.getOut().write("<input type='hidden' name='productItemID' value='" + Integer.valueOf(item.getProductItemID()).toString() + "'/>");
				
				pageContext.getOut().write("<td align='center'>");
				pageContext.getOut()
						.write(Integer.valueOf(item.getProductItemID()).toString());
				pageContext.getOut().write("</td>");
				pageContext.getOut().write("<td align='center'>");
				...
				pageContext.getOut().write("<button type='submit' style='top:0px; left:0px;'>Delete</button>");
